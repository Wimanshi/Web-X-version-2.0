...
<body>
                                            ...
                                            <ul class="dropdown">
                                                <li><a href="./allDevelopers.php">- All Developers</a>
                                                    <ul class="dropdown">
                                                        ...
                                                        <li class="current-item"><a href="./video.php">- Video Editing</a></li>
                                                    </ul>
                                                </li>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcumb--con">
                        <h4 class="title" position="centre">Video Editing</h4>
    ...
    <div class="post-content text-center mb-50">
        <h2>Our skillful Video Editors' List</h2>
    </div>
    <?php
        ...
        while ($row=mysqli_fetch_array($result_set,MYSQLI_ASSOC)){
            ...
            echo "<div class='col-12 col-lg-4'>";
                echo "<div class='single-blog-post bg-img mb-80' style='background-image: url(./img/bg-img/Video_editing.jpg);'>";
