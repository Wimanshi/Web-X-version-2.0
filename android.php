                                        ...
                                        <li><a href="#">- Developer List</a>
                                            <ul class="dropdown">
                                                <li><a href="./allDevelopers.php">- All Developers</a>
                                                    <ul class="dropdown">
                                                        <li class="current-item"><a href="./android.php">- Android Developing</a></li>
    ...
    <?php
        ...
        while ($row=mysqli_fetch_array($result_set,MYSQLI_ASSOC)){
            ...
            echo "<div class='col-12 col-lg-4'>";
                echo "<div class='single-blog-post bg-img mb-80' style='background-image: url(./img/bg-img/Android.jpg);'>";
