...
<body>
    ...
    <div class="post-content text-center mb-50">
        <h2>Our skillful Website Developers' List</h2>
    </div>
    <?php
        ...
        while ($row=mysqli_fetch_array($result_set,MYSQLI_ASSOC)){
            ...
            echo "<div class='col-12 col-lg-4'>";
                echo "<div class='single-blog-post bg-img mb-80' style='background-image: url(./img/bg-img/Website_developing.jpg);'>";
                    echo "<div class='post-content'>";
                        echo "<span class='post-date'><span>";
                        echo $row['username'];
                        echo "</span>";
                        echo "<br>";
                        echo "Website Developer";
                        echo "</span>";
